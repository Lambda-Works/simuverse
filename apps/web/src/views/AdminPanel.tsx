...
import { Plus, Trash2, Save, Settings, Copy, AlertTriangle, ChevronDown, ChevronUp } from 'lucide-react';
...
const AdminPanel = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <AppNavbar title="Administración SimuVerse 3.0" showChildren={false} />
