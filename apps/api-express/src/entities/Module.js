...
exports.Module = exports.ModuleType = void 0;
const typeorm_1 = require("typeorm");
var ModuleType;
(function (ModuleType) {
    ModuleType["COMMUNICATION"] = "communication";
    ModuleType["TOOLS"] = "tools";
    ModuleType["DOCUMENTATION"] = "documentation";
    ModuleType["ASSESSMENT"] = "assessment";
})(ModuleType || (exports.ModuleType = ModuleType = {}));
let Module = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('modules'), (0, typeorm_1.Index)(['name'])];
    ...
    var Module = _classThis = class {
        constructor() {
            ...
            this.created_at = (__runInitializers(this, _config_extraInitializers), __runInitializers(this, _created_at_initializers, void 0));
